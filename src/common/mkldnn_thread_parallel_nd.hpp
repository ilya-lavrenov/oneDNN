...
void parallel_nd(const T0 &D0, const T1 &D1, const T2 &D2,
                 const std::function<void(size_t, size_t, size_t)> & f) {
#if MKLDNN_THR == MKLDNN_THR_TBB
    int nthr = mkldnn_get_max_threads();
...
void parallel_nd(const T0 &D0, const T1 &D1, const T2 &D2, const T3 &D3,
                 const std::function<void(size_t, size_t, size_t, size_t)> & f) {
#if MKLDNN_THR == MKLDNN_THR_TBB
    int nthr = mkldnn_get_max_threads();
...
void parallel_nd(const T0 &D0, const T1 &D1, const T2 &D2, const T3 &D3,
        ...
        const std::function<void(size_t, size_t, size_t, size_t, size_t, size_t)> f) {
#if MKLDNN_THR == MKLDNN_THR_TBB
    int nthr = mkldnn_get_max_threads();
